...
IMPORTANT rules:
- role must be exactly one of: awareness, consideration, conversion, retention
- Minimum 5 channels total
- channel_overlap must have exactly 4 entries — one per funnel phase (awareness, consideration, conversion, retention)
- Each overlap entry's channels array lists the channels used in that phase
CONTEXT: ${briefing}
${ctx}`,
